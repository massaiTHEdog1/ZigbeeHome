<template>
	<div>
		...
		<input type="button" class="form-control form-control-sm w-auto ml-auto mr-auto" value="Click me"/>

		<p class="node-type">Event : Manual trigger</p>
	</div>
</template>
...
export default class ManualTriggerEvent extends Vue {
