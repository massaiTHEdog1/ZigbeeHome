<template>
	<div>
		...
		<p class="mb-0 mt-1">Color :</p>
		<input ref="color" type="color" class="w-100 mb-0" min="0" max="255" v-model="color" df-color/>
		...
		<p class="node-type">Command : Move to color</p>
	</div>
</template>
...
export default class MoveToColorCommand extends Vue {
	...
	@Ref("color") colorElement! : HTMLInputElement;
